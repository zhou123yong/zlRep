...
var getGraphTrace = function(pid,pdid,flag){
    ...
    $.getJSON( 'workflow/process/trace?pid=' + pid, function(infos) {
        ...
        var html = "<div id='imgHiden'><img src='" + imageUrl + "' style='position:absolute; left:0px; top:0px;' />" +
            "<div id='processImageBorder'>" +
            positionHtml +
            "</div>" +
            "</div>";
        ...
        //// 调整图片大小自适应
        //var resize = function() {
        //    $('#imgHiden').css('display', 'block');
        //    if(flag) {
        //
        //        var $container = $('#activitiGialog').parent()[0];
        //        var $img = $('#activitiGialog img')[0];
        //        var scale = $container.offsetWidth / $img.offsetWidth;
        //        $container.style.transform = 'scale(' + scale + ')';
        //        $container.style.height = $img.offsetHeight * scale + 'px';
        //    }
        //};
